...
function twentythirteen_scripts_styles() {
	...
	wp_enqueue_script( 'carousel', get_template_directory_uri() . '/js/owl.carousel.min.js', array( 'jquery' ), '2014-06-08', true );
	...
	// Loads app styles
	wp_enqueue_style( 'app', get_template_directory_uri() . '/css/app.css', array(), '1.00' );
	...
	wp_enqueue_style( 'foundation', get_template_directory_uri() . '/css/foundation.min.css', array(), '3.03' );
	...
	if(is_page('gallery')){
		wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/js/gallery/modernizr.custom.js', array(), '2014-06-08', true );
		wp_enqueue_script( 'imagesloaded', get_template_directory_uri() . '/js/gallery/imagesloaded.js', array(), '2014-06-08', true );
		wp_enqueue_script( 'classie', get_template_directory_uri() . '/js/gallery/classie.js', array(), '2014-06-08', true );
		wp_enqueue_script( 'AnimOnScroll', get_template_directory_uri() . '/js/gallery/AnimOnScroll.js', array(), '2014-06-08', true );
...
function add_thumbnail_sizes() {
	...
	if (class_exists('MultiPostThumbnails')) {
	    ...
	    $custom_made_types = get_post_types(
	array(	'public'   => true,
  	'_builtin' => false
	)
	);
	$types = array_merge($builtin_types, $custom_made_types);
...
add_action( 'init', 'add_thumbnail_sizes');
...
function custom_pagination($numpages = '', $pagerange = '', $paged='') {
  ...
  if ($paginate_links) {
    echo "<nav class='custom-pagination large-12 columns'>";
